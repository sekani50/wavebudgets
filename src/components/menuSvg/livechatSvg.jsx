...
function LiveChatSvgElement() {
  const location = useLocation()
  return (
    <Link to="/main/live-chat">
        <div className="live-chat-svg w-[24px] h-[24px]">
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
      ...
      >
        <path
          ...
          fill={location.pathname === "/main/live-chat"? "#7BBE4A":"#201E1E" }
          fillOpacity={location.pathname === "/main/live-chat"? "1": "0.65"}
        />
        <path
...
export default LiveChatSvgElement;
