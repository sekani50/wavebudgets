...
const AuthCard = ({isVisible}) => {
    ...
    return (
        <div
         ...
         className={isVisible ? "h-[250px] z-40 absolute w-[300px] left-[-200px] bg-white bottom-[-250px] flex flex-col shadow-lg rounded-xl space-y-4 px-6 py-4 justify-center items-center": "hidden"}>
